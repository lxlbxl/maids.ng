...
export default function KnowledgeCreate({ categories, agents, tiers }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.agent.knowledge.store'));
    };

    return (
        <AdminLayout>
            <Head title="Create Knowledge Article" />

            <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6 max-w-6xl mx-auto">
                <div>
                    <h1 className="font-display text-4xl font-light tracking-tight text-white mb-2">Ingest New Intelligence</h1>
                ...
                <div className="space-y-6">
                    <div className="bg-[#121214] border border-white/5 rounded-brand-lg p-8 shadow-2xl">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="text-[10px] font-mono text-white/20 space-y-2 uppercase tracking-widest text-center italic">
                                Set rank to determine agent injection order.
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#121214] border border-white/5 rounded-brand-lg overflow-hidden shadow-2xl">
                        ...
                        <form onSubmit={handleSubmit} className="p-8 space-y-8">
                            ...
                            <div className="flex items-center gap-6 pt-8 border-t border-white/5">
                                ...
                                >
                                    {processing ? 'Processing...' : 'Commit Intelligence Article'}
                                </button>
                                <Link
                                    href={route('admin.agent.knowledge.index')}
