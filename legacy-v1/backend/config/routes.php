...
use App\Controllers\StandaloneVerificationController;
...
return function (App $app) {
    ...
    $app->post('/api/verify-nin-prematch', [VerificationController::class, 'preVerifyNin']);
    $app->get('/api/verification/{id}', [VerificationController::class, 'getStatus']);

    // Standalone NIN Verification
    $app->group('/api/standalone-verification', function (RouteCollectorProxy $group) {
        $group->post('/initiate', [StandaloneVerificationController::class, 'initiate']);
        $group->post('/verify-payment', [StandaloneVerificationController::class, 'verifyPayment']);
        $group->get('/report/{reference}', [StandaloneVerificationController::class, 'getReport']);
    });
