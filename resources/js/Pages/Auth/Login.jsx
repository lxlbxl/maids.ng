            ...
            <div className="min-h-screen bg-ivory dark:bg-[#0f0f10] flex items-center justify-center px-6 relative overflow-hidden transition-theme">
                ...
                <div className="w-full max-w-md relative z-10">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="font-display text-3xl font-light text-espresso dark:text-[#f0ede8] transition-theme">
                            Welcome <em className="italic text-copper">Back</em>
                        </h1>
                        <p className="text-muted dark:text-gray-400 text-sm mt-1">Sign in with your Email or Phone Number</p>
                    </div>

                    <form onSubmit={submit} className="bg-white dark:bg-[#1c1c1e] rounded-brand-xl p-8 border border-gray-200 dark:border-white/10 shadow-brand-1 space-y-5 transition-theme">
                        <div>
                            <label className="block text-sm font-medium text-espresso dark:text-[#f0ede8] mb-1.5">Email or Phone Number</label>
                            <input
                                type="text"
                                value={data.login}
                                onChange={e => setData('login', e.target.value)}
                                className="w-full h-12 border-2 border-gray-200 dark:border-white/10 rounded-brand-md px-4 text-sm focus:border-teal focus:ring-2 focus:ring-teal/20 outline-none transition-all bg-transparent"
                        ...
                        <div>
                            <div className="flex items-center justify-between mb-1.5">
                                <label className="block text-sm font-medium text-espresso dark:text-[#f0ede8]">Password</label>
                            </div>
                            <input
                                type="password"
                                value={data.password}
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center gap-2 cursor-pointer">
                                ...
                                />
                                <span className="text-muted dark:text-gray-400">Remember me</span>
                            </label>
                    ...
                    <p className="text-center text-sm text-muted dark:text-gray-400 mt-8">
